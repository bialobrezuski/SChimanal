...
This project provides a complete Python and Fiji pipeline for processing dual or single-channel fluorescence microscopy images in .lsm format.
It automatically aligns and adjusts channels, applies multiple thresholding algorithms from ImageJ (doi:10.1117/1.1631315), extracts morphological metrics (e.g., droplet count, occupied area, diameter), generates summary and fluorescence intensity plots, performs colocalization analysis using BIOP JACoP (doi:10.1111/j.1365-2818.2006.01706.x), and exports clean Excel and PNG outputs—all while managing files automatically.
